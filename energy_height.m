...
subplot(2,3,4);[wrx,wry]=whisto(wRg2);xlabel('Rg');ylabel('Frequency');axis square;axchange(md4);
subplot(2,3,5);[wpx,wpy]=whisto(wperim2);xlabel('perim');ylabel('Frequency');axis square;axchange(md4);
...
subplot(2,3,1);plot(wsx1,wsy_acc,'linewidth',2);xlabel('s');ylabel('Accumulation frequency');axis square;axchange(md5);
subplot(2,3,2);plot(wtx1,wty_acc,'linewidth',2);xlabel('t');ylabel('Accumulation frequency');axis square;axchange(md5);
subplot(2,3,3);plot(wax1,way_acc,'linewidth',2);xlabel('area');ylabel('Accumulation frequency');axis square;axchange(md5);
subplot(2,3,4);plot(wrx1,wry_acc,'linewidth',2);xlabel('rg');ylabel('Accumulation frequency');axis square;axchange(md5);
subplot(2,3,5);plot(wpx1,wpy_acc,'linewidth',2);xlabel('perim');ylabel('Accumulation frequency');axis square;axchange(md5);
...
subplot(2,3,4);wrsl = w_line_fit(wrx,wry,'b');xlabel('log(rg)');ylabel('log(Frequency)');axis square;hold off;axchange(md5);
subplot(2,3,5);wpsl = w_line_fit(wpx,wpy,'b');xlabel('log(perim)');ylabel('log(Frequency)');axis square;hold off;axchange(md5);
...
subplot(2,3,4);plot(binn,pps_ave,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axchange(2);
subplot(2,3,5);plot(binn,pps_s,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axchange(2);
subplot(2,3,6);plot(binn,pps_be,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axchange(2);
...
subplot(2,3,4);plot(bins,ps_ave,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axis square;axchange(2);
subplot(2,3,5);plot(bins,ps_s,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axis square;axchange(2);
subplot(2,3,6);plot(bins,ps_be,'linewidth',2);xlabel('Frequency');ylabel('Intensity');axis square;axchange(2);
